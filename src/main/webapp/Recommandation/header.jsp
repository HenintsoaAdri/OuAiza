...
<%@ page import="model.*,traitement.*,java.util.Vector,java.time.*"%>
...
<html>
  <head>
    ...
    <meta charset="utf-8">
    <title>O&ugrave; Aiza - Recommandation</title>
  ...
  <body>
    <nav class="teal accent-4">
      <div class="nav-wrapper">
        <a href="/" class="brand-logo"><img src="../img/logo.png" width="150px"></a>
    ...
    <ul id="slide-out" class="side-nav">
      ...
      <li class="active"><a class="waves-effect" href="../Lieu" data-activates="dropdown"><i class="material-icons">place</i> Lieu</a>
          <ul id='dropdown' class='dropdown-content'>
            <li class="active"><a href="../Recommandation"><i class="material-icons">search</i> Recommandations</a></li>
          </ul>
      </li>
    ...
    <div class="container">
		<h3><i class="material-icons small">share</i> Recommandation</h3>
