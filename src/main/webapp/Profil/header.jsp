...
<%@ page import="model.*,traitement.*,traitement.Traitement"%>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
  <head>
  	<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
    <meta charset="utf-8">
    <title>O&ugrave; Aiza - Profil</title>
    ...
    <ul id="slide-out" class="side-nav">
      ...
      <div class="userView">
        <div class="background">
          <img src="../img/party.jpg" height="100%">
        </div>
        <a href="../Profil"><img class="circle" src="<% out.print(Traitement.getInternUrl()); %>imgProfil/<% out.print(p.getPhoto());%>"></a>
        <a href="../Profil"><span class="white-text name"><% out.print(p.getIdentifiantString()); %></span></a>
