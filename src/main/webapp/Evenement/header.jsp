...
<html>
  <head>
    ...
    <meta charset="utf-8">
    <title>O&ugrave; Aiza - &Eacute;v&egrave;nement</title>
  ...
  <body>
    ...
    <ul id="slide-out" class="side-nav">
      <li><% if(session.getAttribute("Profil")!=null){ %>
      <div class="userView">
      ...
      <% } %></li>
      <li><a class="waves-effect" href="../Lieu" data-activates="dropdown"><i class="material-icons">place</i> Lieu</a>
          <ul id='dropdown' class='dropdown-content'>
            <li><a href="../Recommandation"><i class="material-icons">search</i> Recommandations</a></li>
          </ul>
      </li>
      <li class="active"><a class="waves-effect" href="../Evenement"><i class="material-icons">local_bar</i> &Eacute;v&eacute;nement</a></li>
    ...
    <div class="container">
          <h3><i class="material-icons small">local_bar</i>&Eacute;v&eacute;nement</h3>
