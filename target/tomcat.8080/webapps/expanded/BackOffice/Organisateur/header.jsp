...
<title>O&ugrave; Aiza - Administration, Organisateur</title>
</head>
<body>
	<div class="container">
      <div class="row">
          ...
          <header>
            <div class="container">
              <ul id="slide-out" class="side-nav fixed">
                ...
                <li class="active"><a class="waves-effect waves-teal" href="#"><i class="material-icons">group</i> Organisateur</a></li>
