...
<title>O&ugrave; Aiza - Administration, Evenement</title>
</head>
  <body>
    <div class="container">
      <div class="row">
          ...
          <header>
            <div class="container">
              <ul id="slide-out" class="side-nav fixed">
                <li class="logo center"><img src="../../img/logo-negatif.png" alt="" width="200px"></li>
                <li><a class="waves-effect waves-teal" href="../Lieu"><i class="material-icons">location_on</i> Lieu</a></li>
                <li class="active"><a class="waves-effect waves-teal" href="../Evenement"><i class="material-icons">local_bar</i> Ev&egrave;nement</a></li>
                ...
                <li><a class="waves-effect waves-teal" href="#"><i class="material-icons">pie_chart</i> Statistiques</a></li>
                <li><a class="waves-effect waves-teal" href="#"><i class="material-icons">warning</i> Signalements</a></li>
              </ul>
