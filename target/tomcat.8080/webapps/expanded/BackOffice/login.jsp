            ...
            <form class="col s12 valign" method="post" action="#">
              <div class="row">
                <div class="input-field col s12">
                  ...
                  <input name="identifiant" type="identifiant" class="validate" value="<% out.print(identifiant); %>">
                  <label for="identifiant" data-error="invalide" data-success="valide">Adresse email</label>
                </div>
                <div class="input-field col s12">
              ...
              <% try{
            	  if(request.getParameter("connect")!=null){
            		  ...
            		  TraitementProfil.connexion(identifiant, password, session, response);
            	  }
              }catch(Exception e){ 
           		e.printStackTrace(); %>
